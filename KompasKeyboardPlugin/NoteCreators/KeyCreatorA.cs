    ...
    public class KeyCreatorA : KeyCreatorBase
    {
        ...
        public override void Build()
        {
            _sketch.ksLineSeg(_marginLeft, - _marginFront, _marginLeft,
                - 5.3, 1);
            _sketch.ksLineSeg(_marginLeft, - 5.3, _marginLeft - 0.7, - 5.3,
                1);
            _sketch.ksLineSeg(_marginLeft - 0.7, - 5.3, _marginLeft - 0.7,
                - 15.5, 1);
            _sketch.ksLineSeg(_marginLeft - 0.7, - 15.5, _marginLeft - 1.9,
                - 15.5, 1);
        ...
        public KeyCreatorA(ksDocument2D sketch, double marginLeft, double marginFront)
        {
            _sketch = sketch;
