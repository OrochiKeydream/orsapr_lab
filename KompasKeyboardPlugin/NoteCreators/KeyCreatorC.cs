    ...
    public class KeyCreatorC : KeyCreatorBase
    {
        ...
        public override void Build()
        {
            _sketch.ksLineSeg(_marginLeft, - _marginFront, _marginLeft,
                - 15.5, 1);
            _sketch.ksLineSeg(_marginLeft, - 15.5, _marginLeft - 1.3,
                - 15.5, 1);
            _sketch.ksLineSeg(_marginLeft - 1.3, - 15.5, _marginLeft - 1.3,
                - 5.3, 1);
            _sketch.ksLineSeg(_marginLeft - 1.3, - 5.3, _marginLeft - 2.2,
                - 5.3, 1);
        ...
        public KeyCreatorC(ksDocument2D sketch, double marginLeft, double marginFront)
        {
            _sketch = sketch;
